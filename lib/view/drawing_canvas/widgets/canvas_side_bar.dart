...
import 'package:flutter_drawing_board/icons.dart';
...
class CanvasSideBar extends HookWidget {
  ...
  String year;
   ...
   CanvasSideBar({
    ...
    required this.backgroundImage, required this.type, required this.i,
     required this.year, required this.subject,
  }) : super(key: key);
            ...
            Wrap(
              ...
              children: [
                ...
                _IconBox(
                  ...
                  selected: drawingMode.value == DrawingMode.marker,
                  onTap: () => drawingMode.value = DrawingMode.marker,
                  tooltip: 'marker',
                  child: Column(
                    ...
                    children: [
                      Container(
                        width: 32,
                        height:32,
                        color: drawingMode.value == DrawingMode.marker
                            ? Colors.black
                            : Colors.white,
                        child: Icon(FontAwesomeIcons.highlighter,color: drawingMode.value == DrawingMode.marker
                            ? Colors.yellow
                            : Colors.pink,),
                      ),
                    ],
              ...
              children: [
                TextButton(
                  onPressed: allSketches.value.isNotEmpty
                    ...
                    _database.deleteLastItemFromDatabase(type,i,subject,year);
                ...
                TextButton(
                  ...
                  onPressed: () {
                    DatabaseHelper _database=DatabaseHelper();
                    _database.deleteAllItemFromDatabase(type,i,subject,year);
